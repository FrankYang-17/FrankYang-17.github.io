...
I am a fourth-year Ph.D. student at Peking University, advised by Prof. [Xuejun Yang](https://www.semanticscholar.org/author/Xuejun-Yang/1780156) and Prof. [Wenjing Yang](https://www.semanticscholar.org/author/Wenjing-Yang/2120811655). I earned my B.E. degree at China University of Geosciences in 2023. Prior to that, I served for two years (2017-2019) in the People’s Liberation Army  as an assault rifleman and a sniper.

My primary research interest lies in **Foundation Models for Multimodal Learning**, with broader interests in **Causal Inference** and **Reinforcement Learning**. My overarching goal is to build reliable and generalizable multimodal intelligence. As we move toward the next stage of AGI, I believe language models will remain a central engine of intelligence, providing a general interface for reasoning, planning, and decision-making, while increasingly interacting with specialized capabilities for perception, generation, and action. Rather than internalizing every capability within a monolithic model, I am particularly interested in how such intelligence can reason about, compose, and use external capabilities as tools.
...
- [KeyFrame-Compass: Towards Comprehensive Evaluation of Keyframe-Conditioned Video Generation](https://arxiv.org/abs/2607.14202)<br><span style="font-size: 80%;">*Yuqi Tang, Tengfei Liu, Yizheng Lai, Yuran Wang, **Yang Shi†**, Wanshun Su, Zhuoran Zhang, Qixun Wang, Xiaohan Zhang, Xinlei Yu, Xuehai Bai, Xuanyu Zhu, Bohan Zeng, Bozhou Li, Shujie Li, Yifan Dai, Yujie Wei, Shixuan Liu, Haotian Wang, Jialu Chen, Yuanxing Zhang*</span>
