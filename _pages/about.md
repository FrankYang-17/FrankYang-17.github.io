...
**🤖 Models & Training**
- [OmniPack: Unified Token Compression for Efficient Omni-modal Large Language Models]()<br><span style="font-size: 80%;">*Wanshun Su\*, **Yang Shi\***, Feihu Liu, Ziwen Yu, Yan Min, Zhuoran Zhang, Qixun Wang, Haotian Wang, Shixuan Liu, Yuanxing Zhang, Peng Wu‡, Chengfu Huo, Liang Ding‡*</span>
