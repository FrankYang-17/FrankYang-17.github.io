...
- [VTC-Bench: Evaluating Agentic Multimodal Models via Compositional Visual Tool Chaining](https://arxiv.org/abs/2603.15030)<br><span style="font-size: 80%;">*Xuanyu Zhu, Yuhao Dong, Rundong Wang, **Yang Shi**, Zhipeng Wu, Yinlun Peng, YiFan Zhang, Yihang Lou, Yuanxing Zhang, Ziwei Liu, Yan Bai, Yuan Zhou*</span>
